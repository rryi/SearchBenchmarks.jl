...
benchmark(2000, 1000000, source, [bloom_v0,bloom_v3,bloom_v4], path*"(4) BIN degeneration on large patterns",false)
benchmark(2000, 1000000, source, [bloom_v0,bloom_v3,bloom_best], path*"(5) BIN limited bits in bloom filter",false)
benchmark(200, 1000000, source, [bloom_v0,bloom_v3,bloom_best,bmsearch], path*"(6) BIN boyer moore alternative",false)
benchmark(2000, 1000000, source, [bloom_v0,bloom_v3,bloom_best,bmsearch], path*"(7) BIN boyer moore on large patterns",false)
