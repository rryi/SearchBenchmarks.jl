...
benchmark(2000, 100000, source, [bloom_v0,bloom_v3,bloom_v4], path*"(4) TXT degeneration on large patterns",false)
benchmark(2000, 100000, source, [bloom_v3,bloom_v4,bloom_best], path*"(5) TXT limited bits in bloom filter",false)
benchmark(200, 100000, source, [bloom_v0,bloom_v3,bloom_best,bmsearch], path*"(6) TXT boyer moore alternative",false)
benchmark(2000, 100000, source, [bloom_v0,bloom_v3,bloom_best,bmsearch], path*"(7) TXT boyer moore on large patterns",false)
